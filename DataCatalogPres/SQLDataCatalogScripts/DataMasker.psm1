...
function Get-DataSet{
	...
	if ($DataSetLabel -eq 'SSN') {
		[xml]$dataSetXml = '
			<DataSet_USASSN NS="DMS_DataSets" AS="DMSD">
				<InvalidChecksum Value="True" />
				<DigitsOnly Value="False" />
				<SpaceSeparation Value="False" />
				<DashSeparation Value="True" />
				<UniqueValuesOnly Value="True" />
            </DataSet_USASSN>'
	}
